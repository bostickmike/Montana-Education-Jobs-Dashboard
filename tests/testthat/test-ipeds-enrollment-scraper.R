...
# endpoint, captured 2026-08-06 for 2023 (latest available) and 2018 (5
# years prior, for the trend test).

test_that("parse_ipeds_he_enrollment sums FTE across every level_of_study for all 6 institutions", {
...
test_that("compute_enrollment_change computes a real 5-year trend from real 2018 vs 2023 data", {
  ...
  # Real data confirms a mix, not a uniform trend -- every other of the 6
  # institutions shrank over this window.
