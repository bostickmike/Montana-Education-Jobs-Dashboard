...
# extended captured 2026-08-07, and the 4 tribal colleges appended the
# same day when their own fast-follow gap closed. Both from the SAME year
...
test_that("parse_ipeds_he_pell_share computes a real recipients-over-enrollment ratio for all 17 institutions", {
